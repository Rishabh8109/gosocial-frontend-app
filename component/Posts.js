    ...
    <div className={styles.postCard}>
      ...
      <div className={styles.postCardBody}>
        <p className={styles.title}>
          one of the perk working in intternational company is sharing knowladge
          with your collegues
        </p>
        <div>
          <img
            src={
              "https://images.unsplash.com/photo-1531347387918-af516d1e939c?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDR8fG9mZmljZSUyMGltYWdlfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60"
            }
          ...
          <div>
            <img
              src={
                "https://images.unsplash.com/photo-1431540015161-0bf868a2d407?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjJ8fG9mZmljZSUyMGltYWdlfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60"
              }
              alt="Picture of the office"
            />{" "}
            <img
        ...
        <ul className={styles.actions}>
          <li>
            <TiMessage className={styles.icon} /> 225 Comments
          </li>
          <li>
            <FiHeart className={styles.icon} /> 1k Like
          </li>
          <li>
            <FiBookmark className={styles.icon} /> 12 Save
          </li>
          <li>
            <BiShareAlt className={styles.icon} /> 224 Share
          </li>
        </ul>
      </div>
